		...
		<div class="p-75">
			<form v-on:submit.prevent="saveSettings">
				...
				<div class="p-50">
					...
					<input type="text" name="firstName" class="input-middle px-50"  v-model="settings.firstName" placeholder="Введите ваше имя" autocomplete="off">
				</div>
				<div class="p-50">
					<label for="surName" class="pr-75">Отчество</label>
					<input type="text" name="surName" class="input-middle px-50"  v-model="settings.surName" placeholder="Введите ваше отчество" autocomplete="off">
				</div>
				<div class="p-50">
				<label for="gender" class="pr-75">Пол</label>
					<select name="gender" class="input-middle px-50"  v-model="settings.gender">
				...
				<div class="p-50">
					...
					<input type="text" class="input-middle px-50"  name="birthday" v-model="settings.birthday">
				</div>
				<!--status 0-->
				<div class="p-50">
					<label for="bloodType" class="pr-75">Группа крови</label>
					<select name="bloodType" class="input-middle px-50"  v-model="settings.bloodType">
						<option value="">Не выбрано</option>
				...
				<div class="p-50">
					...
					<select name="familyStatus" class="input-middle px-50"  v-model="settings.familyStatus">
						<option value="">Не выбрано</option>
				...
				<div class="p-50">
					...
					<select name="doc_work_place" class="input-middle px-50"  v-model="settings.doc_work_place">
						<option value="">Не выбрано</option>
				...
				<div class="p-50">
					...
					<select name="doc_category" class="input-middle px-50"  v-model="settings.doc_category">
						<option value="">Не выбрано</option>
				...
				<div class="p-50">			
					...
					<select name="med_position" class="input-middle px-50"  v-model="settings.med_position">
