						...
						<div class="modal-container text-center">
							...
							<div class="modal-body p-100">
								<form class="d-flex flex-column" v-on:submit.prevent="addMeasurement">
									<input type="text" name="date" class="form-control text-center" v-model="heightForm.date">
									<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
									<label for="height">Рост</label>
									<input type="number" name="height" placeholder="170" class="form-control text-center" min="1" max="300" v-model="heightForm.height" required="">
									<span class="input-group-addon">см</span>
									<label for="note">Примечание</label>
									<textarea class="form-control" name="note" rows="1" v-model="heightForm.note"></textarea>
